...
public abstract class WebUtils {
	...
	public static String doPost(
		...
		return doPost(url, ctype, content, connectTimeout, readTimeout,charset);
	}
	...
	public static String doPost(
			...
			int readTimeout,String charset) throws IOException {
	...
	protected static String getResponseAsString(HttpURLConnection conn,String charset_temp) throws IOException {
		String charset = "";
		if(charset_temp!=null&&!"".equals(charset_temp))
			charset = charset_temp;
		else
