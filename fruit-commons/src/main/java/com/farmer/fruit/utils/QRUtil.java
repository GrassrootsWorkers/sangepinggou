...
public class QRUtil {
    ...
    public static String decode(String imagePath) {
        ...
        try {
            ...
            try {
                DecodeHintType.class.getClassLoader().loadClass("com.google.zxing.DecodeHintType");
    ...
    /**
     * 生成中间带图片且有前景的二维码
     * @param imagePath 图片生成后的路径
     * @param content 图片内容
     * @param width 图片宽
     * @param height 图片高
     * @param centerImg 中间图片
     * @param centerBackgroundImg 中间图片的背景
     * @param namePrefix 新名称前缀（imagePath的文件名前面加上一个前缀，如：d:/a.png --> d:/yao_a.png）
     * @return 生成后的图片路径
     */
    public static String encode(String imagePath, String content, int width, int height, String centerImg, String centerBackgroundImg, String namePrefix){
        String qrImgPath = QRUtil.encode(content, width, height, imagePath);

        String qrImage = "";
        String waterImgPath = QRUtil.resizeImg(centerImg, width/6, height/6, true);

        String tempImg = QRUtil.addWaterBorder(waterImgPath, centerBackgroundImg);

        qrImage = QRUtil.addImageWater(qrImgPath, tempImg, null == namePrefix ? "yao_" : namePrefix);
    ...
    public static void main(String[] args) {
        ...
        /**部分一开始***********生成常规二维码*************/
        //二维码内容
        String content = "http://www.sangepg.com/SDLZ100000010001.html";
        //二维码宽度
        int width = 50;
        //二维码高度
        int height = 50;
        //二维码存放地址
        String imagePath = "D:\\temp\\2weima.png";
...
//        String waterImgPath = QRUtil.resizeImg("D:\\IdeaProject\\publish\\src\\resource\\image\\yao.png", width/6, height/6, true);
        //
...
//        String qrImage = QRUtil.addImageWater(qrImgPath, waterImgPath,"thatway");
       ...
       // String tempImg = QRUtil.addWaterBorder(waterImgPath, "D:\\IdeaProject\\publish\\src\\resource\\image\\qr_bg.png");

        //生成带有边框图片的二维码,返回的是生成好的二维码图片的所在路径
       // String qrImage = QRUtil.addImageWater(qrImgPath, tempImg,"yao_");
