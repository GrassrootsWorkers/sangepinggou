	...
	require.register("switchery/switchery.js", function(exports, require, module) {
		...
		Switchery.prototype.setPosition = function(clicked) {
			...
			if (checked === true) {
				...
				this.switcher.style.background =this.options.secondaryImage;
	this.switcher.style.backgroundSize =this.options.secondarySize;
				this.setSpeed()
			}
		};
		...
		Switchery.prototype.colorize = function() {
			...
			this.switcher.style.boxShadow = "inset 0 0 0 0px " + this.options.color;
			this.switcher.style.background =this.options.bgImage;
			this.switcher.style.backgroundSize =this.options.bgSize;
		};
