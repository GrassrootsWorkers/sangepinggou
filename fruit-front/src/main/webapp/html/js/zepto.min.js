/* Zepto v1.1.4-95-g601372a - zepto event data ajax assets callbacks deferred detect form fx fx_methods gesture ie - zeptojs.com/license */
var Zepto = function () {
    function Z(t) {
    ...
    function $(t) {
        return L(t) && !M(t) && Object.getPrototypeOf(t) == Object.prototype
    }
    ...
    function B(t, e) {
        return "number" != typeof e || l[W(t)] ? e : e + "px"
    }
    ...
    function X(n, i, r) {
        for (e in i)r && ($(i[e]) || k(i[e])) ? ($(i[e]) && !$(n[e]) && (n[e] = {}), k(i[e]) && !k(n[e]) && (n[e] = []), X(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    ...
    var t, e, n, i, A, O, r = [], o = r.concat, s = r.filter, a = r.slice, u = window.document, f = {}, c = {}, l = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, h = /^\s*<(\w+|!)[^>]*>/, p = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, d = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, m = /^(?:body|html)$/i, g = /([A-Z])/g, v = ["val", "css", "html", "text", "data", "width", "height", "offset"], y = ["after", "prepend", "before", "append"], b = u.createElement("table"), w = u.createElement("tr"), x = {
        ...
        th: w,
        "*": u.createElement("div")
    }, E = /complete|loaded|interactive/, T = /^[\w-]*$/, j = {}, S = j.toString, C = {}, P = u.createElement("div"), N = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return C.matches = function (t, e) {
        ...
        return o && (r = P).appendChild(t), i = ~C.qsa(r, e).indexOf(t), o && P.removeChild(t), i
    }, A = function (t) {
        ...
        var r;
        if (!e)return C.Z();
        if ("string" == typeof e)if (e = e.trim(), "<" == e[0] && h.test(e))r = C.fragment(e, RegExp.$1, i), e = null; else {
            if (i !== t)return n(i).find(e);
            r = C.qsa(u, e)
        } else {
            if (D(e))return n(u).ready(e);
            if (C.isZ(e))return e;
            if (k(e))r = z(e); else if (L(e))r = [e], e = null; else if (h.test(e))r = C.fragment(e.trim(), RegExp.$1, i), e = null; else {
                if (i !== t)return n(i).find(e);
                r = C.qsa(u, e)
            }
        }
        ...
        return !1
    }, n.type = Z, n.isFunction = D, n.isWindow = M, n.isArray = k, n.isPlainObject = $, n.isEmptyObject = function (t) {
        var e;
        for (e in t)return !1;
        return !0
        ...
        var n, r, o, i = [];
        if (_(t))for (r = 0; r < t.length; r++)n = e(t[r], r), null != n && i.push(n); else for (o in t)n = e(t[o], o), null != n && i.push(n);
        return R(i)
    }, n.each = function (t, e) {
        var n, i;
        if (_(t)) {
        ...
        not: function (e) {
            ...
            if (D(e) && e.call !== t)this.each(function (t) {
                ...
                var r = "string" == typeof e ? this.filter(e) : _(e) && D(e.item) ? a.call(e) : n(e);
        ...
        closest: function (t, e) {
            var i = this[0], r = !1;
            for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : C.matches(i, t));)i = i !== e && !F(i) && i.parentNode;
            return n(i)
        },
        parents: function (t) {
        ...
        attr: function (n, i) {
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function (t) {
                if (1 === this.nodeType)if (L(n))for (e in n)Y(this, e, n[e]); else Y(this, n, J(this, i, t, this.getAttribute(n)))
        ...
        offset: function (t) {
            ...
            if (!n.contains(u.documentElement, this[0]))return {top: 0, left: 0};
            ...
            if (arguments.length < 2) {
                ...
                if (k(t)) {
                    ...
                    return n.each(t, function (t, e) {
                        s[e] = o.style[A(e)] || r.getPropertyValue(e)
                    }), s
                }
            }
            var a = "";
            if ("string" == Z(t))i || 0 === i ? a = W(t) + ":" + B(t, i) : this.each(function () {
                this.style.removeProperty(W(t))
            }); else for (e in t)t[e] || 0 === t[e] ? a += W(e) + ":" + B(e, t[e]) + ";" : this.each(function () {
                this.style.removeProperty(W(e))
            });
            return this.each(function () {
        ...
        removeClass: function (e) {
            return this.each(function (n) {
                if ("className" in this) {
                    ...
                    i = G(this), J(this, e, n, i).split(/\s+/g).forEach(function (t) {
                        i = i.replace(I(t), " ")
                    }), G(this, i.trim())
                }
            })
        ...
        toggleClass: function (e, i) {
            return e ? this.each(function (r) {
                var o = n(this), s = J(this, e, r, G(this));
        ...
        position: function () {
            if (this.length) {
                var t = this[0], e = this.offsetParent(), i = this.offset(), r = m.test(e[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : e.offset();
        ...
        n.fn[e] = function (r) {
            var o, s = this[0];
            return r === t ? M(s) ? s["inner" + i] : F(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function (t) {
    ...
    }), C.Z.prototype = H.prototype = n.fn, C.uniq = O, C.deserializeValue = K, n.zepto = C, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    t.fn.delegate = function (t, e, n) {
        ...
        return e && !o(e) ? (t.each(e, function (t, e) {
            h.on(t, s, a, e, f)
        }), h) : (o(s) || r(u) || u === !1 || (u = a, a = s, s = n), (u === n || a === !1) && (u = a, a = n), u === !1 && (u = w), h.each(function (n, r) {
            f && (c = function (t) {
    ...
    function a(n, o, s) {
        var a = n[r] || (n[r] = ++t.uuid), f = e[a] || (e[a] = u(n));
    ...
    var e = {}, n = t.fn.data, i = t.camelCase, r = t.expando = "Zepto" + +new Date, o = [];
    ...
    l.href = window.location.href, t.active = 0, t.ajaxJSONP = function (i, r) {
        ...
        var A, p = o.accepts[f], m = {}, b = function (t, e) {
            m[t.toLowerCase()] = [t, e]
        }, j = /^([\w-]+:)\/\//.test(o.url) ? RegExp.$1 : window.location.protocol, S = o.xhr(), C = S.setRequestHeader;
        if (s && s.promise(S), o.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", p || "*/*"), (p = o.mimeType || p) && (p.indexOf(",") > -1 && (p = p.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(p)), (o.contentType || o.contentType !== !1 && o.data && "GET" != o.type.toUpperCase()) && b("Content-Type", o.contentType || "application/x-www-form-urlencoded"), o.headers)for (r in o.headers)b(r, o.headers[r]);
        if (S.setRequestHeader = b, S.onreadystatechange = function () {
                if (4 == S.readyState) {
                    S.onreadystatechange = w, clearTimeout(A);
                    var e, n = !1;
                    if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == j) {
                        if (f = f || x(o.mimeType || S.getResponseHeader("content-type")), "arraybuffer" == S.responseType || "blob" == S.responseType)e = S.response; else {
                            e = S.responseText;
                            try {
                            ...
                            if (n)return y(n, "parsererror", S, o, s)
                        }
                        v(e, S, o, s)
        ...
        return o.timeout > 0 && (A = setTimeout(function () {
            S.onreadystatechange = w, S.abort(), y(null, "timeout", S, o, s)
    ...
    t.Callbacks = function (e) {
        e = t.extend({}, e);
        var n, i, r, o, s, a, u = [], f = !e.once && [], c = function (t) {
    ...
    t.when = function (i) {
        var f, c, l, r = e.call(arguments), o = r.length, s = 0, a = 1 !== o || i && t.isFunction(i.promise) ? o : 0, u = 1 === a ? i : n(), h = function (t, n, i) {
            return function (r) {
    ...
    function e(t, e) {
        var n = this.os = {}, i = this.browser = {}, r = t.match(/Web[kK]it[\/]{0,1}([\d.]+)/), o = t.match(/(Android);?[\s\/]+([\d.]+)?/), s = !!t.match(/\(Macintosh\; Intel /), a = t.match(/(iPad).*OS\s([\d_]+)/), u = t.match(/(iPod)(.*OS\s([\d_]+))?/), f = !a && t.match(/(iPhone\sOS)\s([\d_]+)/), c = t.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), l = /Win\d{2}|Windows/.test(e), h = t.match(/Windows Phone ([\d.]+)/), p = c && t.match(/TouchPad/), d = t.match(/Kindle\/([\d.]+)/), m = t.match(/Silk\/([\d._]+)/), g = t.match(/(BlackBerry).*Version\/([\d.]+)/), v = t.match(/(BB10).*Version\/([\d.]+)/), y = t.match(/(RIM\sTablet\sOS)\s([\d.]+)/), b = t.match(/PlayBook/), w = t.match(/Chrome\/([\d.]+)/) || t.match(/CriOS\/([\d.]+)/), x = t.match(/Firefox\/([\d.]+)/), E = t.match(/\((?:Mobile|Tablet); rv:([\d.]+)\).*Firefox\/[\d.]+/), T = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/), j = !w && t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/), S = j || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
        (i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), f && !u && (n.ios = n.iphone = !0, n.version = f[2].replace(/_/g, ".")), a && (n.ios = n.ipad = !0, n.version = a[2].replace(/_/g, ".")), u && (n.ios = n.ipod = !0, n.version = u[3] ? u[3].replace(/_/g, ".") : null), h && (n.wp = !0, n.version = h[1]), c && (n.webos = !0, n.version = c[2]), p && (n.touchpad = !0), g && (n.blackberry = !0, n.version = g[2]), v && (n.bb10 = !0, n.version = v[2]), y && (n.rimtabletos = !0, n.version = y[2]), b && (i.playbook = !0), d && (n.kindle = !0, n.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && n.android && t.match(/Kindle Fire/) && (i.silk = !0), w && (i.chrome = !0, i.version = w[1]), x && (i.firefox = !0, i.version = x[1]), E && (n.firefoxos = !0, n.version = E[1]), T && (i.ie = !0, i.version = T[1]), S && (s || n.ios || l) && (i.safari = !0, n.ios || (i.version = S[1])), j && (i.webview = !0), n.tablet = !!(a || b || o && !t.match(/Mobile/) || x && t.match(/Tablet/) || T && !t.match(/Phone/) && t.match(/Touch/)), n.phone = !(n.tablet || n.ipod || !(o || f || c || g || v || w && t.match(/Android/) || w && t.match(/CriOS\/([\d.]+)/) || x && t.match(/Mobile/) || T && t.match(/Touch/)))
    }
    ...
    var i, a, u, f, c, l, h, p, d, m, n = "", r = {
        Webkit: "webkit",
        Moz: "",
        O: "o"
    }, o = document.createElement("div"), s = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, g = {};
    t.each(r, function (t, r) {
        ...
        var b, x, j, w = {}, E = "", T = this, S = t.fx.transitionEnd, C = !1;
        if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n)w[h] = n, w[p] = i + "s", w[m] = y + "s", w[d] = r || "linear", S = t.fx.animationEnd; else {
            x = [];
            for (b in n)s.test(b) ? E += b + "(" + n[b] + ") " : (w[b] = n[b], x.push(v(b)));
            E && (w[a] = E, x.push(a)), i > 0 && "object" == typeof n && (w[u] = x.join(", "), w[f] = i + "s", w[l] = y + "s", w[c] = r || "linear")
        }
        return j = function (e) {
    ...
    var n = window.document, r = (n.documentElement, t.fn.show), o = t.fn.hide, s = t.fn.toggle;
