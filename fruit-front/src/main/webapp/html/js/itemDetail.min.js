...
function changeOptName(a) {
    2 === a ? $("#optname").html("活动未开始") : 0 === a ? $("#optname").html("等待抽奖") : 3 === a && $("#optname").html("查看中奖名单")
}
...
function renderDrawTime(a, b) {
    ...
    if ($("#drawCountdown").length <= 0) {
        switch (b) {
            case 2:
                c = '<div class="notesBox"><div class="groupFail"><span>距活动开始还剩：</span><span id="drawCountdown"><i>xx:xx:xx</i></span><span>请耐心等待哦</span></div></div>';
                break;
            case 1:
                c = '<div class="notesBox"><div class="groupFail"><span>距活动结束还剩：</span><span id="drawCountdown"><i>xx:xx:xx</i></span><span>请尽快组团哦</span></div></div>'
        }
...
var g_item_date = {
    ...
    init: function () {
        ...
        var b = $("<div>");
        b.addClass("groupMore"), b.html('<div class="groupMore-title">以下小伙伴即将成团，您可以直接参与</div><div class="groupMore-list" id="groupMore-list"></div>'), $(".groupExplain").before(b);
        for (var c = 0; c < a.length; c++) {
            var d = a[c], e = "";
            0 === parseInt(d.needsNum) || (e = '<a class="groupMore-item" href="http://wx.360haoyao.com/wgroup/order/orderDetail.action?pinOrderId=' + d.pinId + '"><span class="groupMore-img"><img src="' + d.ownerPic + '" alt=""></span><div class="groupMore-info"><span class="groupMore-text">还剩<i class="groupMore-time" data-currentTime="' + d.currentTime + '" data-endTime="' + d.endTime + '"></i>结束,还剩<i>' + d.needsNum + '</i>人</span></div><div class="redBtn groupMore-Link">立即参团<i></i></div></a>', $("#groupMore-list").append(e))
        }
...
/*$(function () {
        getShare.init(),
        getMoreWgroupItem(),
        $("#slider li").each(function (a, b) {
        $("#sliderPos").append('<a href="javascript:window.itemSwipe.slide(' + a + ', 400) ;"></a>')
    }), $("#sliderPos a").eq(0).addClass("on");
    var a = !1;
    2 === $("#slider li").length && (a = !0), $("#appTips").length > 0 && $("#appTips").on("click", ".modal-close",
        function (a) {
...
var gDrawCountdown = {
    endTime: 0, currentTime: 0, timeLoop: !1, init: function (a) {
        ...
        2 == a ? getDrawType() : $("#drawCountdown").parent().html("此次抽奖活动已结束！")
    }
};
